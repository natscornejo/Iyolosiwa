                ...
                <div class="col-12">
                    <div class="card p-2">
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="Titulo" name="title" value="{{ $post->title }}"
                                                required="">
                                        </div>
                                        <div class="form-floating mb-3">
                                            <label for="floatingInput">Fecha de publicacion</label>
                                            <input type="date" class="form-control" id="floatingInput"
                                                placeholder="Fecha" name="date" value="{{ $post->date }}"
                                                required="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input type="text" class="form-control" id="floatingInput"
                                                placeholder="Autor" name="author" value="{{ $post->author }}">
                                        </div>
                                        <div class="form-floating mb-3">
                                            ...
                                            <input type="text" class="form-control" id="floatingInputValue"
                                                placeholder="Hashtags" value="{{ $post->keyboards }}" name="keywords">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            ...
                                            <textarea type="text" class="form-control" id="floatingTextarea" placeholder="Contenido" style="height: 250px;"
                                                name="body" id="" value="{{ $post->body }}" required=""></textarea>
                                        </div>
                            ...
                            </form> <!-- Formulario Editar Noticia -->
                        </div>
                    </div>
                </div>
            </div> <!-- Formulario -->
