                    ...
                    <form class="" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-floating mb-3 ">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                for="floatingInput" name="name" value="{{ old('name') }}" required autocomplete="name"
                                autofocus placeholder="Nombre y Apellido">
                            @error('name')
                        ...
                        <div class="form-floating mb-3">
                            ...
                            @enderror
                            <label for="password-confirm" class="form-label" id="floatingInputGrid">
