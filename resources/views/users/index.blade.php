                                ...
                                <table id="basic-datatable" class="table table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-info btn-xs waves-effect mb-2 waves-light" data-toggle="tooltip" data-placement="bottom" title="Ver" href="{{ route('usuarios.show', $user->id) }}">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a class="btn btn-warning btn-xs waves-effect mb-2 waves-light" data-toggle="tooltip" data-placement="bottom" title="Editar" href="{{ route('usuarios.edit', $user->id) }}">
                                                ...
                                                <form method="POST" action="{{ route('usuarios.destroy', $user->id) }}" style="display: inline-block;">
                                                    ...
                                                    <button class="btn btn-outline-danger btn-xs waves-effect mb-2 waves-light" type="submit" data-toggle="tooltip" data-placement="bottom" title="Borrar" onsubmit="return confirm('Esta acción eliminara definitivamente el usuario, ¿Estas seguro?')">
