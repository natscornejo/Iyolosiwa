...
<div class="right-bar">
    ...
    <div class="slimscroll-menu">
        ...
        <div class="user-box">
            <div class="user-img">
                <img src="{{ asset('assets/images/users/Avatar-Lg-BWBLK-1.jpg')}}" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
        ...
        <div class="p-3">
            <div class="inbox-widget">
                <div class="inbox-item">
                    <div class="inbox-item-img"><img src="{{ asset('assets/images/users/Avatar-S-RED-2.jpg')}}" class="rounded-circle" alt=""></div>
                    <p class="inbox-item-author"><a href="javascript: void(0);" class="text-dark">Tomaslau</a></p>
                    <p class="inbox-item-text">I've finished it! See you so...</p>
                </div>
                <div class="inbox-item">
                    <div class="inbox-item-img"><img src="{{ asset('assets/images/users/Avatar-S-BLK-4.jpg')}}" class="rounded-circle" alt=""></div>
