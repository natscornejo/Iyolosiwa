                        ...
                        <div class="card-body">
                            ...
                            <div class="text-left mt-3">
                                @forelse ($role->permissions as $permission)
                                    <p class="text-muted mb-2 font-13"><strong>Nombre :</strong><span
                                            class="badge badge-light-primary badge-pill">{{ $permission->name }}</span></p>
                                @empty
