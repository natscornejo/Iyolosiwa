                                                ...
                                                <div class="col-12 text-right">
                                                    @can('permission_create')
                                                        <a href="{{ route('roles.create') }}"
                                                            class="btn btn-sm btn-outline-primary">Añadir rol</a>
                                                    @endcan
                                                </div>
                                            </div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    @forelse ($role->permissions as $permission)
                                                                        <span
                                                                            class="badge badge-light-success badge-pill">{{ $permission->name }}</span>
                                                                    @empty
                                                                        <span
                                                                            class="badge badge-light-danger badge-pill">Sin
                                                                            permisos</span>
                                                                    @endforelse
                                                                </td>
