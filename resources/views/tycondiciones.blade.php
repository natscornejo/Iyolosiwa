...
<div class="container">
	<div class="row col-md-12 py-4">
		...
		<div class="pb-4">
			...
			<p class="textos">Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Iyolosiwa, ubicado en <a href="{{ route('Inicio') }}">{{ route('Inicio') }}</a>
		...
		<div class="pb-4">
			<h2>Cookies</h2>
			<p class="textos">El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a <a href="{{ route('Inicio') }}">{{ route('Inicio') }}</a>, aceptaste utilizar las cookies necesarias.
		...
		<div class="pb-4">
			...
			<p class="textos">Usar cualquier otra descripción de nuestro sitio web al que está vinculado que tenga sentido dentro del contexto y formato del contenido en el sitio de la parte vinculante.</p>
			<p class="textos">No se permitirá el uso del logotipo de {{ route('Inicio') }} u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.</p>
		</div>
		...
		<div class="pb-4">
			...
			<p class="textos">Nos reservamos el derecho de solicitar que elimines todos los enlaces o cualquier enlace en particular a nuestro sitio web. Apruebas eliminar de inmediato todos los enlaces a nuestro sitio web cuando se solicite. También nos reservamos el derecho de modificar estos términos y condiciones y su política de enlaces en cualquier momento. Al vincular continuamente a nuestro sitio web, aceptas estar vinculado y seguir estos términos y condiciones de vinculación.</p>
		</div>

		<div class="pb-4">
			<h2>Eliminación de enlaces de nuestro sitio web</h2>
			<p class="textos">Si encuentras algún enlace en nuestro sitio que sea ofensivo por cualquier motivo, puedes contactarnos e informarnos en cualquier momento. Consideraremos las solicitudes para eliminar enlaces, pero no estamos obligados a hacerlo ni a responder directamente.</p>
			<p class="textos">No nos aseguramos de que la información de este sitio web sea correcta. No garantizamos su integridad o precisión, ni prometemos asegurarnos de que el sitio web permanezca disponible o que el material en el sitio se mantenga actualizado.</p>
		</div>
		
		<div class="pb-4">
			<h2>Exención de responsabilidad</h2>
			<p class="textos">En la medida máxima permitida por la ley aplicable, excluimos todas las representaciones, garantías y condiciones relacionadas con nuestro sitio web y el uso de este. Nada en este descargo de responsabilidad:</p>
			<ol class="list-group list-group-numbered pb-3">
