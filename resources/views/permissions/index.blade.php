                                        ...
                                        <div class="row">
                                            <div class="col-12 text-right">
                                                @can('permission_create')
                                                    <a href="{{ route('permisos.create') }}" class="btn btn-sm btn-outline-primary">Añadir permiso</a>
                                                @endcan
                                            </div>
                                        </div>
                                                    ...
                                                    @forelse ($permissions as $permission)
                                                        <tr>
                                                            ...
                                                            <td class="td-actions btn-group-sm">
                                                                ...
                                                                @can('permission_show')
                                                                    <a class="btn btn-primary" data-bs-toggle="tooltip" data-bs-title="Ver" href="{{ route('permisos.show', $permission->id) }}">
                                                                        <i class="fas fa-eye"></i>
                                                                    </a>
                                                                @endcan

                                                                @can('permission_edit')
                                                                    <a class="btn btn-warning" data-bs-toggle="tooltip" data-bs-title="Editar" href="{{ route('permisos.edit', $permission->id) }}">
